...
import DesignerOfertaCard from './DesignerOfertaCard'
import { Link } from 'react-router-dom'

const DesignerOfertaContent = () => {
    const jobs = [
        {
            title: "Diseño de publicidad",
            description: "Estamos en búsqueda de un diseñador que nos ayude con el proceso creativo para un anuncio de publicidad el cual se planea mostrar en la web"
        },
        {
    ...
    return (
        <div className="content-card">
            <div className="designer-job-list-content-container">
                <div className="designer-job-list-content-row-1">
                    <p className="poppins-64">Mis Ofertas</p>
                </div>
                <div className="designer-job-list-content-row-2">
                    <div className="designer-job-list-content-row-2-column-1">
                    ...
                    <div className="designer-job-list-content-row-2-column-2">
                        <Link style={{ textDecoration: 'none'}} to='/designer/ofertadetalle'>
                            <DesignerOfertaCard
                    ...
                    <div className="designer-job-list-content-row-2-column-3">
...
export default DesignerOfertaContent
